...
def plot_adc():
        ...
        adc0=np.array(struct.unpack('>8192h',fpga.read('b1_bram',4096*4,0)))
        ...
        X.real = realX.astype(np.int16)
        X.imag = imagX.astype(np.int16)
        ...
        fig.canvas.manager.window.after(50, plot_adc)
...
if __name__ == '__main__':
    ...
    if fpga.is_connected():
        ...
        print ('ERROR connecting to server  on port %i.\n')
        exit_fail()
